                 ...
                 <div class="employee-list common-pad-tab">
                         ...
                         <table class="" cellspacing="0" cellpadding="10">
                            ...
                            <!-- <tr class="">
                                ...
                                <td>26-12-1990</td>
                                <td>BE-IT</td>
                                <td><button class="view-pad"><a href="http://localhost/arpesh/employee-database-practical/viewEmployeeDetail.php">View</a></button></td>
                                <td><button class="view-pad"><a href="http://localhost/arpesh/employee-database-practical/viewEmployeeDetail.php">Edit</a></button></td>
                                <td><button class="view-pad"><a href="http://localhost/arpesh/employee-database-practical/viewEmployeeDetail.php">Delete</a></button></td>
                            </tr>
